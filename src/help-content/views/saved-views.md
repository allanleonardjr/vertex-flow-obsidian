...
A Saved View bundles a [layout](help://layouts), grouping, sort, filters,
column state and field visibility under one name in the sidebar. Edits from the
view bar are a draft until you save — nothing overwrites the saved definition
until you choose to. An "Assigned to me" or "Mentions me" view is just a Saved
View with a `self` filter.
