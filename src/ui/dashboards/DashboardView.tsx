...
export function DashboardView({
	...
	const tabs = useTabs();
	const dashboard = snapshot.dashboards.find((d) => d.id === dashboardId) ?? null;
	...
	if (!dashboard) {
		return (
			<div className="vf-empty-view">
				<p>This dashboard no longer exists.</p>
			</div>
		);
	}
...
function DashboardBody({
	...
	const filterProxy: SavedView = { ...fallbackView(), filters: effective.filters };
