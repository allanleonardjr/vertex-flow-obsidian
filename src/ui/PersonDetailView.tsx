...
export function PersonDetailView({
  ...
  return (
    <div className="vf-browse">
      ...
      <div className="vf-browse-meta" style={{ padding: "10px 14px 10px" }}>
        <span>
          {pluralize(usage.assigneeTaskPaths.length, "task")} assigned
        </span>
        <span>
          {pluralize(usage.ownerProjectPaths.length, "project")} owned
        </span>
