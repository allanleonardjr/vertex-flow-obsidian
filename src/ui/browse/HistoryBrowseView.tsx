...
const ACTION_LABEL: Record<string, string> = {
  ...
  "view.migrate-storage": "migrated",
  "view.migrate-query-format": "migrated",
  "dashboard.migrate-storage": "migrated",
  "dashboard.migrate-filter-format": "migrated",
  "project.migrate-query-format": "migrated",
  "task.migrate-recurrence-date-modes": "migrated",
